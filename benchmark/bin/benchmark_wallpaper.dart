...
Future<void> main(List<String> arguments) async {
  ...
  for (var i = 0; i < warmupRuns; i++) {
    await ImageFfmpeg.decodeImage(encoded, maxWidth: 96, maxHeight: 96);
  }
  ...
  for (var i = 0; i < measuredRuns; i++) {
    ...
    image = await ImageFfmpeg.decodeImage(encoded, maxWidth: 96, maxHeight: 96);
    stopwatch.stop();
